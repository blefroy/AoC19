...
def shortest_path(matches,x_1,y_1,x_2,y_2):
	path_length = []
	while matches:
		concat = matches.pop()
		x_coord,y_coord = concat.split(',')
		path_length.append(x_1.index(x_coord) + y_1.index(y_coord)+x_2.index(x_coord)+y_1.index(y_coord))
